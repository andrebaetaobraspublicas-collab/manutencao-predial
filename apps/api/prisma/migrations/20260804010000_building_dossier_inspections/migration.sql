...
CREATE TABLE `BuildingInspection` (
  ...
  PRIMARY KEY (`id`),
  INDEX `BuildingInspection_tenantId_buildingId_inspectionDate_deletedAt_idx` (`tenantId`, `buildingId`, `inspectionDate`, `deletedAt`),
...
CREATE TABLE `BuildingAttachment` (
  ...
  INDEX `BuildingAttachment_tenantId_buildingId_kind_deletedAt_idx` (`tenantId`, `buildingId`, `kind`, `deletedAt`),
  INDEX `BuildingAttachment_inspectionId_idx` (`inspectionId`),
