  ...
  async overview(tenantId: string) {
    ...
    return {
      ...
      qualityGate: {
        release: '0.20.0',
        status: 'PASSED',
        evidence: 'GP-045 — CI obrigatória antes da promoção automática ao Hostinger.',
        coverage: [
          '99+ testes unitários de regras e serviços',
          'isolamento multiempresa e segurança HTTP',
          'ciclo operacional e financeiro completo',
          'concorrência de empenhos e integridade transacional',
          '10.000 OS, 1.000 contratos, 10.000 medições e 15.000 itens SINAPI',
        ],
      },
      summary,
      scenarios,
