...
const TOPICS: ManualTopic[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Concilie a planilha contratual', description: 'Na aba Planilha orçamentária, confira o total contra o valor atual. Corrija a diferença e só então ative a planilha como referência oficial.' },
    ...
    details: [
      ...
      { title: 'Situação da conciliação', description: 'Verde indica cadeia íntegra; amarelo pede complementação; vermelho identifica quebra de teto ou rastreabilidade que impede a homologação.' },
    ],
  ...
  },
  {
    ...
    title: 'Orçamentos contratuais, de OS e catálogos SINAPI',
    summary: 'Concilie a planilha do contrato, importe referências, pesquise itens e componha os três estágios de custo da OS.',
    ...
    steps: [
      { title: 'Ative a planilha do contrato', description: 'O total deve ser igual ao valor contratual atual. Uma planilha divergente permanece em elaboração e não abastece novas OS.' },
